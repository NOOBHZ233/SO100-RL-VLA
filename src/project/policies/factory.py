...
from project.configs.policies import PreTrainedConfig
from project.configs.types import FeatureType
from project.datasets.lerobot_dataset import LeRobotDatasetMetadata
from project.datasets.utils import dataset_to_policy_features
from project.envs.configs import EnvConfig
from project.envs.utils import env_to_policy_features
from project.policies.act.configuration_act import ACTConfig
from project.policies.diffusion.configuration_diffusion import DiffusionConfig
from project.policies.groot.configuration_groot import GrootConfig
from project.policies.pi0.configuration_pi0 import PI0Config
from project.policies.pi05.configuration_pi05 import PI05Config
from project.policies.pretrained import PreTrainedPolicy
from project.policies.sac.configuration_sac import SACConfig
from project.policies.sac.reward_model.configuration_classifier import RewardClassifierConfig
from project.policies.utils import validate_visual_features_consistency
from project.processor import PolicyAction, PolicyProcessorPipeline
from project.processor.converters import (
    batch_to_transition,
...
def get_policy_class(name: str) -> type[PreTrainedPolicy]:
    ...
    """
    if name == "diffusion":
        from project.policies.diffusion.modeling_diffusion import DiffusionPolicy

        return DiffusionPolicy
    elif name == "act":
        from project.policies.act.modeling_act import ACTPolicy

        return ACTPolicy

    elif name == "pi0":
        from project.policies.pi0.modeling_pi0 import PI0Policy

        return PI0Policy
    elif name == "pi05":
        from project.policies.pi05.modeling_pi05 import PI05Policy
        ...
        from project.policies.sac.reward_model.modeling_classifier import Classifier

        return Classifier
    elif name == "groot":
        from project.policies.groot.modeling_groot import GrootPolicy
...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    if isinstance(policy_cfg, DiffusionConfig):
        from project.policies.diffusion.processor_diffusion import make_diffusion_pre_post_processors
        ...
        from project.policies.act.processor_act import make_act_pre_post_processors
        ...
        from project.policies.pi0.processor_pi0 import make_pi0_pre_post_processors
        ...
        from project.policies.pi05.processor_pi05 import make_pi05_pre_post_processors
        ...
        from project.policies.sac.processor_sac import make_sac_pre_post_processors
        ...
        from project.policies.sac.reward_model.processor_classifier import make_classifier_processor
        ...
        from project.policies.groot.processor_groot import make_groot_pre_post_processors
