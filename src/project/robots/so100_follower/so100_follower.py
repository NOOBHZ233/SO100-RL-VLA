...
from project.cameras.utils import make_camera_from_config
from project.motors import Motor, MotorCalibration, MotorNormMode

from project.motors.feetech import (
    FeetechMotorsBus,
    OperatingMode,
)

from project.processor import RobotAction, RobotObservation
from project.utils.decorators import check_if_already_connected, check_if_not_connected

from ..robot import Robot
from ..utils import ensure_safe_goal_position
from .so100_follower_config import SOFollowerRobotConfig
...
class SOFollower(Robot):
    ...
    def __init__(self, config: SOFollowerRobotConfig):
        ...
        self.cameras = make_camera_from_config(config.cameras)
